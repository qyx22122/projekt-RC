...
\end{abstract}
	...
	Vroči plini uhajajo skozi šobo, ki jih zaradi zožanja v vratu, pospeši do zvočne hitrosti in potem ko se začne tlak manjšati do normalnega zračnega tlaka pospešijo tudi preko zvočne
	hitrosti.
...
\end{equation}
	To količino sva se odločila meriti v tej raziskovalni nalogi.

	\subsection{Gorivo}
	Vrst trdnih goriv za raketne motorje je zelo veliko, ampak imajo vsa v osnovi podobno sestavo. Vsa so sestavljena iz goriva in oksidatorja. V večini primerov so dodani še
	katalizatorji in sredstva za strjevanje. Midva sva se odločila za gorivo, ki ga pogosto poimenujejo "rocke candy". Ta je sestavljen iz saharoze in kalijevega nitrata ter občasno
